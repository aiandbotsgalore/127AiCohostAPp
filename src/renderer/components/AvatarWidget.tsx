...
export const AvatarWidget: React.FC<AvatarWidgetProps> = ({ vadStatus, audioLevelRef, onStatusAction }) => {
    ...
    useEffect(() => {
        ...
        const initParticles = () => {
            // Access ref directly to avoid passing it as dependency if possible,
            // but here we use vadStatus prop which is reactive.
    ...
    }, [vadStatus.isSpeaking, audioLevelRef]); // Re-run if isSpeaking changes to adjust particle count logic
