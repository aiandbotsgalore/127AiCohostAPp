...
Your voice is **Charon** - deep, resonant, and commanding authority.` },
    ...
    const handleSavePrompt = () => {
        setModalConfig({
            ...
            description: 'Enter a name for this prompt template:',
    ...
    const handleModalSubmit = (value: string) => {
        if (modalConfig.type === 'addPreset') {
            ...
            const promptName = value.trim();
            if (promptName) {
                setSavedPrompts(prev => [...prev, { name: promptName, content: systemPrompt }].slice(0, 50));
                showToast(`Prompt "${promptName}" saved`);
            }
                            ...
                            <div style={styles.settingsSection}>
                                ...
                                <div style={styles.shortcutList}>
                                    ...
                                    <div style={styles.shortcutRow}>
                                        ...
                                        <span>Focus Transcript Search</span>
                                    </div>
                                    <div style={styles.shortcutRow}>
